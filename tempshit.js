...
// const googleTTS = require("google-tts-api"); // CommonJS version
// const {
//   createAudioPlayer,
//   createAudioResource,
//   joinVoiceChannel,
...
//     .setName("say")
//     .setDescription("Say something in a voice channel!")
...
//     if (text.length > 200) {
//       return interaction.reply({
//         content: "⚠️ Text is too long. Please keep it under 200 characters.",
//         ephemeral: true,
//       });
//     }
...
//               });
//               await this.updateDashboard(interaction, player, client, message);
//             } else if (client.config.filters[filterName]) {
//               // Toggle filter
